        ...
        <div className="hero">
          <Grid>
            <img
              ...
              src={developLogoImg}
              alt="Compass Development logotype"
            />
          </Grid>
        </div>
        <section className="catalog">
          <div className="container intro">
            <Row center="lg">
              <Col lg={8}>
                ...
                <button className="intro__button" type="button" name="button">
                  Contact The Team
                </button>
              </Col>
            </Row>
          ...
          <Grid>
            <a className="offering" href="">
              <img
                className="offering__preview"
                src={offeringImg}
                srcset="img/appartment-preview@2x.jpg 2x"
                alt="The Harrison"
              />
          ...
          <Grid>
            <a className="offering" href="">
              <img
                className="offering__preview"
                src={offeringImg}
                srcset="img/appartment-preview2@2x.jpg 2x"
          ...
          <Grid>
            <a className="offering" href="">
              <img
                className="offering__preview"
                src={offeringImg}
                srcset="img/appartment-preview3@2x.jpg 2x"
                alt="152 Elizabeth"
              />
              <section className="offering__info">
